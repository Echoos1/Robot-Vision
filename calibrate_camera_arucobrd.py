...
calib_imgs_path = root.joinpath("calib_img/aruco")

# For validating results, show aruco board to camera.
aruco_dict = aruco.getPredefinedDictionary(aruco.DICT_5X5_100)

#Provide length of the marker's side
markerLength = 30  # Here, measurement unit is mm.

# Provide separation between markers
markerSeparation = 10   # Here, measurement unit is mm.

# create arUco board
board = aruco.GridBoard_create(5, 6, markerLength, markerSeparation, aruco_dict, 0)
...
if calibrate_camera == True:
    ...
    np.savez('CameraCalibArUCo.npz', ret=ret, mtx=mtx, dist=dist, rvecs=rvecs, tvecs=tvecs)
